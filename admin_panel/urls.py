...
urlpatterns = [
    ...
    path('add-job/', views.add_job, name='admin_add_job'),
    path('admin_panel/view-job/<int:job_id>/', views.view_job, name='admin_view_job'),
    path('admin_panel/edit-job/<int:job_id>/', views.edit_job, name='admin_edit_job'),
    path('admin_panel/delete-job/<int:job_id>/', views.delete_job, name='admin_delete_job'),
